...
def find_coordinates(stock):
    ...
    for date in yearLows:
        ...
        coordinates[date].append(slope_max(dates,date,maximum,point_map)) # Slope from local max # 
        coordinates[date].append(slope_min(dates,date,minimum,point_map)) # Slope from local min #
